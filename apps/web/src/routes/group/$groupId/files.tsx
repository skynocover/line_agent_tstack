...
const GroupFilesPageContent = () => {
  ...
  const handleCopyLink = (fileId: string) => {
    const link = `${storageBaseUrl}/groups/${groupId}/${fileId}`;
            ...
            <div className="flex min-w-0 flex-1 items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <button
                  ...
                  title={file.fileName}
                  onClick={() =>
                    window.open(`${storageBaseUrl}/groups/${groupId}/${file.fileId}`, '_blank')
                  }
                >
                  {displayName}
                </button>
      ...
      >
        ...
        <div className="mb-6 flex flex-col gap-4">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <h1 className="font-bold text-2xl text-gray-900 sm:text-3xl">群組檔案管理</h1>
              <p className="mt-1 text-gray-600 text-sm sm:text-base">
                群組 ID: <code className="rounded bg-gray-100 px-1 py-0.5 text-xs">{groupId}</code>
              </p>
            </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              <button
                                ...
                                onClick={() =>
                                  window.open(
                                    `${storageBaseUrl}/groups/${groupId}/${file.fileId}`,
                                    '_blank',
                                  )
                                }
                              >
...
export const Route = createFileRoute('/group/$groupId/files')({
  component: GroupFilesPageContent,
